...
import com.swahilib.flingElementDownUp
import com.swahilib.waitAndFindObject
import com.swahilib.waitForObjectOnTopAppBar
...
fun MacrobenchmarkScope.setAppTheme(isDark: Boolean) {
    ...
    waitForObjectOnTopAppBar(By.text("SwahiLib"))
}
