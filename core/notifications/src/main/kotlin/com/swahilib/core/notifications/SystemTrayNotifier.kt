...
private const val TARGET_ACTIVITY_NAME = "com.swahilib.MainActivity"
...
private const val DEEP_LINK_SCHEME_AND_HOST = "https://www.swahilib.apps.samples.google.com"
    ...
    override fun postNewsNotifications(
        ...
        val newsNotifications = truncatedNewsResources.map { newsResource ->
            createNewsNotification {
                setSmallIcon(R.drawable.core_notifications_ic_app_notification)
